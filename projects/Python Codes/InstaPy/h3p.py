...
session.set_comments(
    [
        ...
        "Really Cool",
        "I love your Images",
        "You have some sublime Images here!",
        "Simply stunning",
        "So awesome",
...
session.set_use_clarifai(
    enabled=True,
    secret="d7GfOyk0Eb6PwuPeWj2F3kPbA_oGvxQGOGgOcWRQ",
    proj_id="createurb&w",
)
#                                        ^
...
session.clarifai_check_img_for(
    ["architecture_view", "blackandwhite"],
    comment=True,
    comments=[
        "Exceptionell!",
...
session.clarifai_check_img_for(
    ["blackandwhite", "urbanarchitecture", "schwarzweiss", "minimalism"],
    comment=True,
