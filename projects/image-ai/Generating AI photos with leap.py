...
API_KEY = "fab69fe1-ce9f-4253-b081-7a51d1a46f7c"
...
def create_model(title):
    ...
    payload = {"title": title, "subjectKeyword": "@me"}
...
def get_model_version(model_id, version_id):
    url = (
        f"https://api.tryleap.ai/api/v1/images/models/{model_id}/versions/{version_id}"
    )
...
inference_id, status = generate_image(
    model_id, prompt="A photo of @me with a tall black hat and sunglasses"
)
while status != "finished":
    time.sleep(10)
