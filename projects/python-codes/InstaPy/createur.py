...
session.set_comments(
    [
        "Awesome and simply amzaing work on your part! The light and atmosphere are catching!",
        "This is indeed proper awesome photography",
        "I indeed love your Images!",
        "You have some really sublime Images here!",
        "Simply stunning!",
        "So awesome image and work!",
...
session.set_use_clarifai(
    enabled=True, secret="k_G6bITL7lT6wlStO00bHefj2dgKJvBT4TGyhxH8", proj_id="createur"
)
#                                        ^
...
session.clarifai_check_img_for(
    ...
    comments=[
        "Exceptionell!",
        "I like that atmosphere! This is really great captured light",
    ],
)
session.clarifai_check_img_for(
    ["mountains", "landscape", "beach", "minimalism"],
    comment=True,
    comments=["So wonderful!!", "Sublime!!!"],
)
