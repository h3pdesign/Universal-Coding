...
inflation = checkindicator(
    "https://api.db.nomics.world/v22/series/WB/WDI/FP.CPI.TOTL.ZG-EU?observations=1"
)
...
fig.update_layout(
    xaxis_range=["2003-07-01", "2020-12-31"],
    title_text="Interest Rates, Unemployment, 10y yields, inflation UE, volume sales",
