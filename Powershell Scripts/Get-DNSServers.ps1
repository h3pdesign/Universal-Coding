function Get-DNSServers { 
    ...
    .Example 1
        Get-DNSServers.ps1 -ComputerName GLL-AUR-FS61
		Get the DNS servers information from a remote computer GLL-AUR-FS61.

#>

#$counter = 1
#$ComputerName = get-content C:\GeoNIC_Scripte\ServerList.txt
#$OutputObj = "C:\GeoNIC_Scripte\DNSResult.csv"
...
#Get-DNSServers -ComputerName C:\GeoNIC_Scripte\ServerList.txt
Get-DNSServers -ComputerName 10.45.204.76
