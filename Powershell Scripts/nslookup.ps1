...
$InputFile = 'C:\Users\hipeders\OneDrive - COMPUTACENTER\Coding\Powershell Scripts\nslookup.txt'
$addresses = get-content $InputFile
$reader = New-Object IO.StreamReader $InputFile
§ipvalresults =  C:\Users\hipeders\OneDrive - COMPUTACENTER\Coding\Powershell Scripts\ipvalresults.csv

function get-ipvalidation{
...
get-ipvalidation | export-csv §ipvalresults -NoTypeInformation
invoke-item §ipvalresults
